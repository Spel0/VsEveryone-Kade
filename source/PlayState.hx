...
class PlayState extends MusicBeatState
{
	...
	public static var customSpeed:Bool = false;
	...
	*/
	...
	function changeSpeed(speed:Float) {
		if (customSpeed == false) {
			FlxG.save.data.scrollSpeed = speed;
		}
	}
	...
	override function stepHit()
	{
		...
		if (curStep >= 1440 && curSong == 'Mashup')
            {
                boyfriend.playAnim('hey', false, false, 15);
	...
	function changeDad(name:String)
	{
		remove(dad);
	...
	override function beatHit()
	{
		...
		else if ((curBeat == 23 || curBeat == 31 || curBeat == 39) && curSong == "Mashup") {
				boyfriend.playAnim('hey', true);
		}
